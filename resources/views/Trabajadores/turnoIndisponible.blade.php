    ...
    <div class="container-fluid">
        ...
        <header>
            <div class="banner">
                ...
                <img src="{{ asset('storage/' . $empresa->image) }}" alt="Imagen de {{ $empresa->nombre }}" class="imgProf">
                @endif
        ...
        <main>
            <div class="LinkCaducado text-center">
                <div>
                    <h1>Turno Indisponible<i class="fa-solid fa-circle-xmark" style="color:red;"></i></h1>
                </div>
                <div>
