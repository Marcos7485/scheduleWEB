...
<div class="form1">
    ...
    <div>
        <form action="{{ route('trabajador.update-disp') }}" method="POST">
            @csrf
            ...
            <div class="text-center">
                <a href="{{ route('trabajador.disponibilidad', ['id' => $info->idTrabajador]) }}" class="btn btn-danger">Cancelar &nbsp;<i class="fa-solid fa-circle-xmark"></i></a>
                <button type="submit" class="btn btn-success">Guardar &nbsp;<i class="fa-solid fa-square-check"></i></button>
            </div>
        </form>
    </div>
    <div>
        <form action="{{ route('trabajador.update-disp-todas') }}" method="POST">
            @csrf
